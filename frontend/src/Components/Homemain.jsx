...
const Homemain = () => {
    ...
    return (
        <>
            ...
            {movie.length != 0 && <div>
                <h1 className='mt-[10%]  text-4xl md:text-5xl text-white font-bold flex justify-center mb-12'>Recommeded movies for you .... </h1>
                <MovieSwiper moviedetails={moviedetails} movienames={movie} />
            </div>}
